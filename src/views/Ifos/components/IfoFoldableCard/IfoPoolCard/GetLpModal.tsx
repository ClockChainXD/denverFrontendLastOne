...
import { Modal, ModalBody, Text, Image, Button, Link, OpenNewIcon } from '@denverswap/uikit'
    ...
    <Modal title={t('LP Tokens required')} onDismiss={onDismiss}>
      <ModalBody maxWidth="288px">
        <Image
          ...
          mb="24px"
        />
        <Text mb="16px">{t('You’ll need DNR-BNB LP tokens to participate in the IFO!')}</Text>
